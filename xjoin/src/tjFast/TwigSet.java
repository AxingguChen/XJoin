...
public class TwigSet  {
	...
	void beginJoin(){
      ...
      //�������ڲ���
		...
		//idList_all = showAllPathSolutions();
		...
		/**
		if(mergeAllPathSolutions.getPathNumber(finalResults, leaves) >0
				&& idList_all.size()>1
				&& idList_all.get(0).get(0).equals("true") && idList_all.get(1).get(0).equals("true")
				&& idList_all.get(0).get(1).equals(idList_all.get(1).get(1))) {
			System.out.println("Twig matched");
