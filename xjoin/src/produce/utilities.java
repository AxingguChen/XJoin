package produce; /**
 * Used in loadDataSet and initilizeDTDTable class
 */
...
public class utilities {
    ...
    static int[] maxLabel(Vector v) {
        if (v == null) {
            System.out.println("Input vector is null in maxLabel function !!!");
            return null;
        }
    ...
    {
        if (v == null) {
            System.out.println("Input vector is null in MaxMinLabelPosition function !!!");
            return null;
        }
